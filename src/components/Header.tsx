  ...
  return (
    <header className="bg-slate-900 text-white border-b border-slate-800 sticky top-0 z-30 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-3.5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline-block px-2 py-0.5 bg-indigo-500/20 border border-indigo-400/30 text-indigo-300 rounded text-xs font-semibold">
                  115學年度
                </span>
              </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              ...
              <span>{isSheetConnected ? 'Google Sheet 資料庫 (已連線)' : '連結 Google Sheet 資料庫'}</span>
            ...
            <button
              onClick={onOpenSpecs}
              className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-indigo-300 hover:text-white rounded-lg text-xs font-medium border border-slate-700 transition-colors flex items-center gap-1.5 shadow-2xs"
            >
            ...
            <button
              ...
              className="px-2.5 py-1.5 bg-slate-800 hover:bg-rose-900/40 text-slate-300 hover:text-rose-300 rounded-lg border border-slate-700 transition-colors flex items-center gap-1.5 text-xs font-medium"
            >
        ...
        <div className="flex border-t border-slate-800 pt-1 text-xs">
          <button
          ...
          >
            ...
            <span>Google Doc 格式文件與試算表匯出</span>
          </button>
        </div>
      </div>
    </header>
